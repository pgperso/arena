...
export function CommunityCard({
  ...
  return (
    <Link
      href={`/tribunes/${slug}`}
      className="group rounded-xl border border-gray-200 p-4 transition hover:border-gray-300 hover:shadow-md sm:p-5"
    >
      ...
      {description && (
        <p className="line-clamp-2 text-xs text-gray-600 sm:text-sm">{description}</p>
      )}
    </Link>
  );
}
